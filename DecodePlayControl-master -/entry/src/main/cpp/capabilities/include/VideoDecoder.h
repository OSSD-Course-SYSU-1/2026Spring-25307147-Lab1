...
#ifndef VIDEOPLAYBACKCONTROLONSURFACE_VIDEODECODER_H
#define VIDEOPLAYBACKCONTROLONSURFACE_VIDEODECODER_H
...
public:
    ...
    int32_t RenderOutputBuffer(uint32_t bufferIndex, bool render);
    int32_t Start();
    int32_t Release();
...
#endif // VIDEOPLAYBACKCONTROLONSURFACE_VIDEODECODER_H